...
VEM        = 1 - (1 - VE) / (1 - VES)
rV         = 1.0 / 100
vaccination_strategies = ["20-49_first"]
model      = "vaccine_rate"
data       = dict()
r = 1.5
    ...
    for gamma in gammas:
        ...
        for strategy in vaccination_strategies:
            ...
            for i in range(len(alpha_s)): 
                ...
                data[country][gamma][strategy].append((delta_baseline - delta_solution) / delta_baseline)
                
                
import pickle as pkl
with open("../output/gamma_sensitivity.pkl", "wb") as file: 
    pkl.dump(data, file) 