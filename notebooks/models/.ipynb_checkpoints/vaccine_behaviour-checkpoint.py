...
def BV_system(y, t, beta, eps, mu, omega, chi, f, r, vt, dt, alpha, gamma, VES, VEM, C, Nk, Delta, IFR, model):
    ...
    # compliance / non-compliance rate
...
def integrate_BV(ics, T, R0, eps, mu, omega, chi, f, IFR, Delta, r, alpha, gamma, rV, VES, VEM, Cs, Nk, vaccination_strategy, model, dates, step=1):
    """
